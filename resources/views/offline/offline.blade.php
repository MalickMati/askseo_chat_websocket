...
<body>
    ...
    <div class="container">
        ...
        <p>Looks like your internet connection is offline. Reconnect the internet or change the network please.</p>
        <button class="back-button" onclick="window.location.href='/login';">Go to Login</button>
    </div>
